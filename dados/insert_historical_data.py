...
df_jus = pd.read_csv('Telemetria_Construserv_2026-03-28_jusante.csv', encoding='UTF-8',
...
df_mon = pd.read_csv('Telemetria_Construserv_2026-03-28_montante.csv', encoding='UTF-8',
                 sep=';',skiprows=1, skipfooter=1, engine='python', decimal=',',
                na_values = '-')
...
db_path = Path(__file__).parent / "rio.db"
